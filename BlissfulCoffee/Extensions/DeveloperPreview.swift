...
class DeveloperPreview{
    var coffees:[Coffee]=[
        ...
        Coffee(title: "Espresso",
               ...
               sizes: [.Small, .Large], image: .coffee4, hasDiscount: true, discountAmount: 0.91  ),
        ...
        Coffee(title: "Americano",
               ...
               sizes: [.Small, .Medium, .Large], image: .coffee3, hasDiscount: false),
        ...
        Coffee(title: "Latte",
               ...
               sizes: [.Small, .Medium, .Large], image: .coffee5, hasDiscount: true, discountAmount: 1.1),
